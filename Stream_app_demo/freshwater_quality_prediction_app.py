...
@st.cache_resource
def loadModel():
  model=requests.get("https://api.wandb.ai/files/hari141v/Intel%20oneAPI%20-%20Predict%20the%20quality%20of%20freshwater%20Model/2spdvngn/shapash_catboost_smart_predictor.pkl")
